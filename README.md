...
ElectroVision is an AI-powered educational platform that detects electronic components using a YOLOv8 object detection model and provides interactive explanations through an AI Tutor. The system aims to make learning electronics more engaging for students, beginners, and hobbyists.
...
4.Ensure the trained YOLOv8 model (best.pt) is placed in the project directory.
...
5.The application identifies the electronic component using the trained YOLOv8 model.
